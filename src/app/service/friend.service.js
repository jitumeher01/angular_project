...
var FriendService = (function () {
    function FriendService(_urlService, _http, _authService) {
        this._urlService = _urlService;
        this._http = _http;
        this._authService = _authService;
        this.user = new user_1.User();
    }
    FriendService.prototype.usergetAllFriend = function () {
        console.log(this._authService.getTokenHeader());
        return this._http.get(this._urlService.userFriendsUrl, this._authService.getTokenHeader())
